...
export default function EmailChangeFailed() {
  ...
  return (
    ...
    >
      ...
      <Stack spacing={2}>
        <Button variant="contained" size="large" fullWidth onClick={() => navigate(Path.auth.requestEmailChange)} startIcon={<History />}
        ...
        <Button onClick={() => navigate(Path.account.profile)}
