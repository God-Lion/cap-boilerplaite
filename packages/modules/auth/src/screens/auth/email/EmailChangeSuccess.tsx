...
export default function EmailChangeSuccess() {
  ...
  return (
    ...
    >
      ...
      <Stack spacing={2}>
        <Button fullWidth variant="contained" size="large" onClick={() => navigate(Path.team)} endIcon={<ArrowForward />}
        ...
        <Button fullWidth variant="outlined" size="large" startIcon={<Logout />} onClick={() => navigate(Path.signin)}
