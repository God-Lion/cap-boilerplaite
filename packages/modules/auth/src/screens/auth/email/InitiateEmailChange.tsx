...
import { useChangeEmail } from '../../../hooks/useUserQuery'
            ...
            <form onSubmit={handleSubmit}>
              <Stack spacing={3}>
                ...
                <Box>
                  ...
                  <TextField fullWidth type={showPassword ? 'text' : 'password'} placeholder="••••••••" value={password} onChange={(e) => setPassword(e.target.value)} disabled={isPending} required
