...
import { useCreateOIDCClient } from '../../../hooks'
    ...
    >
      ...
      <Box sx={{ mb: 4 }}>
        <Button
          ...
          to={(Path.auth as any).oidcConfigBrowser}
          startIcon={<ArrowBack />}
      ...
      {newCredentials ? (
        ...
        >
          ...
          <Box sx={{ mt: 5, display: 'flex', gap: 2, justifyContent: 'flex-end' }}>
            <Button variant="outlined" component={RouterLink} to={(Path.auth as any).oidcConfigBrowser}>
              {t('common.done', 'Done')}
            </Button>
          </Box>
        </Card>
        ...
        >
          <Box component="form" onSubmit={handleSubmit(onSubmit)} sx={{ p: 4 }}>
            ...
            <Box sx={{ display: 'flex', justifyContent: 'flex-end', gap: 2, pt: 2, borderTop: '1px solid', borderColor: 'divider' }}>
              <Button component={RouterLink} to={(Path.auth as any).oidcConfigBrowser} color="inherit" sx={{ fontWeight: 600 }}>
