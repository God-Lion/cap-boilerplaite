...
export default function OrganizationProfile() {
  ...
  const handleVerifyDomain = () => {
    ...
    verifyDomainMutation.mutate({ domain: pendingDomain.trim(), organizationId: Number(id) }, {
      onSuccess: () => {
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
          ...
          <Box>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 0.5 }}>
              <Button
                startIcon={<ArrowBack />}
                onClick={() => navigate(Path.organizations)}
                sx={{
                  p: 0,
                  minWidth: 'auto',
              ...
              <CardContent sx={{ p: 3 }}>
                ...
                <Stack spacing={2}>
                  ...
                  <Button
                    ...
                    variant='outlined'
                    startIcon={<Mail />}
                    onClick={() => navigate(Path.invitations.replace(':id', id!))}
                    sx={{ justifyContent: 'flex-start', textTransform: 'none', fontWeight: 700 }}
                  >
            ...
            <Stack divider={<Divider />}>
              ...
              >
                ...
                <Button
                  ...
                  size='small'
                  startIcon={<Security />}
                  onClick={() => navigate(Path.policies.replace(':id', id!))}
