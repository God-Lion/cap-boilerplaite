...
/**
 * Data structure for billing address
 */
...
/**
 * Props for the BillingAddressDialog component
 */
export type BillingAddressDialogProps = {
  open: boolean
...
const initialAddressData: BillingAddressData = {
  firstName: '',
  lastName: '',
  country: '',
  address1: '',
...
/**
 * Dialog for adding or editing billing addresses.
 * Used in admin billing management contexts.
 */
export const BillingAddressDialog = ({ open, setOpen, data, onSubmit }: BillingAddressDialogProps) => {
  const initialSelected: string = customInputData?.find((item) => item.isSelected)?.value || ''

  const [selected, setSelected] = React.useState<string>(initialSelected)
  const [addressData, setAddressData] = React.useState<BillingAddressData>(initialAddressData)

  const handleChange = (prop: string | React.ChangeEvent<HTMLInputElement>) => {
