/**
 * @deprecated This legacy BaseTheme is superseded by the unified preset system.
 * All palette, component, and spacing tokens are now driven by `TenantThemeConfig`
 * and the `THEME_PRESETS` dictionary in `src/types/presets.ts`.
 *
