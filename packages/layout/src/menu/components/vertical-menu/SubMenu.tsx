...
import type { OpenSubmenu } from '../../contexts/verticalMenuContext'
import type { MenuItemProps } from './MenuItem'
import type { ChildrenType, RootStylesType, SubMenuItemElement } from '../../types'
import SubMenuContent from './SubMenuContent'
import MenuButton from './MenuButton'
import { menuButtonStyles } from '../../styles/vertical/menuButtonStyles'
...
const SubMenu: React.ForwardRefRenderFunction<HTMLLIElement, SubMenuProps> = (props, ref) => {
  ...
  const handleSlideToggle = (): void => {
    ...
    if (openSubmenusRef?.current && openSubmenusRef?.current.length > 0)
      openSubmenusRef.current.splice(0)
  }
