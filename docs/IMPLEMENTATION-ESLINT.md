      ...
      patterns: [
        {
          ...
          message: '❌ ARCHITECTURAL VIOLATION: UI components in src/app cannot import from apps/ directory. Keep components isolated from business logic.',
        },
        {
          group: ['**/src/app/Modules/**'],
          message: '❌ ARCHITECTURAL VIOLATION: Core components cannot import from app-specific modules. Extract to core/ if needed.',
        },
      ]
    }],
      ...
      zones: [
        {
          ...
          message: '❌ UI components cannot import from business modules. Extract to @/core if shared.',
        },
        {
          target: './src/core',
          from: './src/app',
...
export const architectureRules = {
  ...
  'no-restricted-imports': ['error', {
    patterns: [
      {
        group: ['**/apps/**'],
        message: '❌ UI components cannot import from apps/. Violation of Rule 1: Component Isolation.',
      },
      {
        group: ['**/Modules/**'],
