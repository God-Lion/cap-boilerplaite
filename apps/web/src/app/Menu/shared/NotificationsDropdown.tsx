...
// Component Imports
import { Notifications, Drafts, Close, BarChart, Email } from '@mui/icons-material'
import { themeConfig, useSettings, type ThemeColor } from '@cap/platform-core'
import CustomAvatar, { CustomAvatarProps } from '@cap/module-auth/src/components/CustomAvatar'
